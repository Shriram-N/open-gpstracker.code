   ...
   public Uri insert(Uri uri, ContentValues values)
   {
      ...
      switch (match)
      {
         case WAYPOINTS:
            ...
            Location loc = new Location(GPStrackingProvider.class.getSimpleName());
            ...
            //            Log.d( this, "Have inserted to segment "+segmentId+" with waypoint "+waypointId );
         ...
         case WAYPOINT_METADATA:
            ...
            break;
         default:
            Log.e(GPStrackingProvider.this, "Unable to match the insert URI: " + uri.toString());
            insertedUri = null;
            break;
      }
      return insertedUri;
   ...
   public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder)
   {
      ...
      switch (match)
      {
         ...
         case LIVE_FOLDERS:
            ...
            break;
         default:
            Log.e(GPStrackingProvider.this, "Unable to come to an action in the query uri: " + uri.toString());
            return null;
      }
