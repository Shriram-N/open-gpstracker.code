...
public class LoggerMapTest extends ActivityInstrumentationTestCase2<LoggerMap>
{
   ...
   /**
    * Usecase A: Start logging Start the MapView and start / stop the logging
    * 
   ...
   public void testStartTracking() throws InterruptedException
   {
      ...
      Assert.assertTrue("Title contains the current route name",
            this.mLoggermap.getTitle().toString().contains("testroute"));
   ...
   public void testSpeedIncreaseColoring() throws InterruptedException
   {
      ...
      mLoggermap.runOnUiThread(new Runnable()
         {
            public void run()
            {
