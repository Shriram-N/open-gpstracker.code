...
import nl.sogeti.android.gpstracker.content.GPStrackingProvider;
...
public class GPStrackingProviderTest extends ProviderTestCase2<GPStrackingProvider>
{
   ...
   public void testMakeTwoTracks()
   {
      ...
      Cursor waypointsTwoCursor = this.mResolver.query(waypointsTwoUri, new String[] { Waypoints.SEGMENT }, null, null,
            null);
   ...
   public void testInsertHighPrecisionAndExportHighPrecision()
   {
      ...
      Cursor waypointCursor = this.mResolver.query(waypointUri,
            new String[] { Waypoints.LONGITUDE, Waypoints.LATITUDE }, null, null, null);
      waypointCursor.moveToFirst();
   ...
   public void testInsertMetaData()
   {
      ...
      Cursor segmentMetaData = this.mResolver.query(segmentMetaDatari, new String[] { MetaData.KEY, MetaData.VALUE },
            null, null, null);
      Cursor waypointMetaData = this.mResolver.query(waypointsMetaDataUri,
   ...
   public void testDeleteTrackWithMetaData()
   {
      ...
      Cursor metadata = this.mResolver.query(MetaData.CONTENT_URI, new String[] { MetaData.KEY, MetaData.VALUE }, null,
            null, null);
   ...
   public void testUpdateTrackWithMetaData()
   {
      ...
      int segmentRows = this.mResolver.update(segmentMetaDataUri, args, MetaData.KEY + " = ? ",
            new String[] { "a test" });
      int waypointRows = this.mResolver.update(waypointsMetaDataUri, args, MetaData.KEY + " = ? ",
            new String[] { "a test" });
      ...
      Cursor segmentMetadata = this.mResolver.query(segmentMetaDataUri, new String[] { MetaData.VALUE }, MetaData.KEY
            + " = ? ", new String[] { "a test" }, null);
      Cursor waypointMetadata = this.mResolver.query(waypointsMetaDataUri, new String[] { MetaData.VALUE },
            MetaData.KEY + " = ? ", new String[] { "a test" }, null);
      metadata.requery();
